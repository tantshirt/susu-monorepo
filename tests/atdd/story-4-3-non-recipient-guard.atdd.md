...
## Scenario 1: Wrong-slot member cannot claim another rotation
...
## Scenario 2: Non-member wallet cannot satisfy the member-position PDA
...
## Scenario 3: Forged recipient-slot PDA cannot be substituted
...
## Scenario 4: Forged PDA state cannot mismatch signer identity
...
## Scenario 5: Valid recipient path remains available
