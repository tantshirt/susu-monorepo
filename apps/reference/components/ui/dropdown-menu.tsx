...
/**
 * DropdownMenu — Radix wrapper used by 7.6 locale dropdown. Token-only
 * surfaces; UX-DR28 focus ring on item.
 */
...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "z-[80] min-w-[8rem] overflow-hidden rounded-xl border border-text/20 bg-white p-1.5 text-text shadow-2 ring-1 ring-text/10 backdrop-blur-none",
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.Label
    ref={ref}
    className={cn("px-2 py-1.5 text-caption font-semibold text-muted", className)}
    {...props}
  />
));
