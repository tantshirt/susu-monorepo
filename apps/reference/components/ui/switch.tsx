 ...
 * cross-skin trust color via `bg-signal`.
 */
...
>(({ className, ...props }, ref) => (
  <SwitchPrimitive.Root
    ref={ref}
    className={cn(
      "peer inline-flex h-6 w-11 shrink-0 cursor-pointer items-center rounded-pill border border-border",
      "transition-colors",
      ...
      "data-[state=checked]:border-signal data-[state=checked]:bg-signal data-[state=unchecked]:bg-surface2",
      className,
    )}
    {...props}
  >
    <SwitchPrimitive.Thumb
      className={cn(
        "pointer-events-none block h-5 w-5 rounded-pill bg-surface shadow-1 ring-0",
