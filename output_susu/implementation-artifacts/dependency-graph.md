...
| 4 | `sprint-status.yaml` marks `epic-4` `in-progress`; Stories 4.1, 4.2, and 4.3 are `done`; Story 4.4 is `ready-for-dev`; Stories 4.5 is `done`; Story 4.6 is `ready-for-dev`. | Story 4.1 merged via PR #157; Story 4.2 merged via PR #158; Story 4.3 merged via PR #159; Story 4.5 merged via PR #160. | Ready to continue at 4.4 |
