...
| 7.11 | 7 | <RotationCard />, <MemberAvatar />, <CurveVisualizer /> static-svg | done | #75 | #206 | merged | 7.4, 7.6, 7.7, 7.10 | ✅ Done |
...
| 9.1 | 9 | Audit sign-off gate verification (NFR-S1) | done | #90 | #217 | merged | 5.8 | ✅ Done |
| 9.2 | 9 | Mainnet deploy with upgrade authority burned at deploy | ready-for-dev | #91 | — | — | 9.1 | ⚠ Ready for prep; HARD STOP for USER AUTHORIZATION before execution |
...
- **8.1** depends on: 1.4, 5.1, 5.6, 8.2, 8.3 _(8.4 dependency removed — cycle fix; epics.md AC §8.4 says 8.4 is downstream of 8.1)_
- **8.2** depends on: 5.4
