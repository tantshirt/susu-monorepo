...
| 4 | `sprint-status.yaml` marks `epic-4` `in-progress`; Stories 4.1 and 4.2 are `done`; Stories 4.3-4.6 are `ready-for-dev`. | Story 4.1 merged via PR #157; Story 4.2 merged via PR #158. | Ready to continue at 4.3 and 4.5 |
