...
| 4 | `sprint-status.yaml` marks `epic-4` `in-progress`; Stories 4.1, 4.2, and 4.3 are `done`; Stories 4.4-4.6 are `ready-for-dev`. | Story 4.1 merged via PR #157; Story 4.2 merged via PR #158; Story 4.3 merged via PR #159. | Ready to continue at 4.4 and 4.5 |
...
- **Ready to Work** for Epic 4 now points to 4.4 and 4.5; 4.1 is merged via PR #157, 4.2 is merged via PR #158, and 4.3 is merged via PR #159. 4.6 depends on 4.1-4.5 complete/merged and remains blocked until 4.4 and 4.5 are merged.
