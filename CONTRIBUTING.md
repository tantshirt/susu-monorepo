...
- Story 1.4 owns the CI workflow scaffold and script wiring.
- Until then, run lightweight local checks for changed surfaces and document what you executed in your PR.
